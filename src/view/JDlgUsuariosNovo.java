...
public class JDlgUsuariosNovo extends javax.swing.JDialog {
    ...
    public JDlgUsuariosNovo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Cadastro de ususarios");
...
JDlgUsuariosNovoIa jDlgUsuariosNovoIa = new JDlgUsuariosNovoIa (null, true);
       jDlgUsuariosNovoIa.setVisible(true);        // TODO add your handling code here:
